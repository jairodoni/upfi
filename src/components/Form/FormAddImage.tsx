...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const mutation = useMutation(
    ...
    {
      onSuccess: () => {
        //invalidando os dados antigos para dar refresh e listar com as novas informações
    ...
    try {
      if (!imageUrl) {
        toast({
          ...
          description: 'É preciso adicionar e aguardar o upload de uma antes de realizar o cadastro.'
        });
        return;
      }

      //para aguardar o resultado da promise
